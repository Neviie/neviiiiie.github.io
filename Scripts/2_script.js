/* функция добавления ведущих нулей */
		...
		// Убирает элемент new_control и меняет его класс чтобы он не изменялся
		var ost = document.querySelector('.new_control');
			ost.style.display = "none";

			ost.classList.remove("new_control");
			ost.classList.add("ostt");

			// Убирает элемент button и меняет его класс чтобы он не изменялся
		var ost = document.querySelector('.button');
			ost.style.display = "none";
